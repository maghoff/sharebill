function() {
    ...
    var get_column = function(id) {
        if (!(id in column_map)) {
            ...
            $("table#recent tbody>tr").append($('<td class="credits currency"></td>'));
            $("table#recent tbody>tr").each(function() { $(this).children("td.credits").first().before($('<td class="debets currency"></td>')) });
